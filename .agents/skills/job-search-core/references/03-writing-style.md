...
5. **NO unverified company claims.** Verify every company-specific statement independently before inclusion. Do not trust a posting, search-result snippet, or reviewer suggestion as evidence. Start from the company name, navigate to an official source, and follow `09-web-research.md`. If a claim cannot be verified, generalize it or omit it.
