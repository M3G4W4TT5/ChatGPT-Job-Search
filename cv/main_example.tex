...
%% Synthetic layout and CI fixture only.
%% Never populate or use this tracked file as candidate evidence.
...
\begin{itemize}
    \item \textnormal{[Achievement or responsibility 1 - be specific, use numbers where possible]}
    \item \textnormal{[Achievement or responsibility 2]}
    \item \textnormal{[Achievement or responsibility 3]}
    \item \textnormal{[Achievement or responsibility 4]}
\end{itemize}}}
...
\begin{itemize}
    \item \textnormal{[Achievement or responsibility 1]}
    \item \textnormal{[Achievement or responsibility 2]}
    \item \textnormal{[Achievement or responsibility 3]}
\end{itemize}}}
